...
public class Ex1 {
	...
	public static void main(String[] args) {
		 ...
		 * - 슈퍼클래스(Super class) = 부모 클래스(조상클래스) = 상위클래스
		 ...
		 * - 자바는 단일 상속만 지원하므로 동시에 2개 이상의 클래스를 상속 받을 수 없음
		...
		// Child 클래스는 자신의 클래스 내의 멤버 뿐만아니라
		// 슈퍼클래스 Parent 클래스로부터 상속받은 멤버도 선언없이 사용 가능
		c.name = "홍길동";
		c.parentPrn();
...
// => 메서드 : programmingWell() 메서드 정의(파라미터 없음, 리턴값 없음)
class 나 extends 아버지 {
	String pc = "컴퓨터";
...
// => 서브클래스명(Child) 뒤에 extends 슈퍼클래스명(Parent) 를 불러서 상속
