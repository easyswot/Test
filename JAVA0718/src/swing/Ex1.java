 ...
 * ------------------------------------------------------------------
 * 자주 사용되는 용어
 * 1. 컨테이너 : 여러 컴포넌트를 하나로 묶여서 부착 가능한 객체
 * 			- 프레임과 패널을 주로 사용
 * 			- JFrame 클래스와 JPannel 클래스로 구현
