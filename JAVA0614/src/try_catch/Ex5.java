...
public class Ex5 {
	...
	public static void main(String[] args) {
		 ...
		 * 	 finally 블록에 기술된 코드들은 예외 발생 여부와 관계없이 실행함
		 * - 일반적인 try 구문 바깥의 코드도 예외 발생 여부와 관계없이 실행되는 것은 동일하나
		 * 	 try ~ catch 블록 내에서 return 문의 사용으로 인해 메서드 수행 종료되더라도
		 ...
		 * 	 finally 블록 내에 자원 반환 코드를 기술하면 예외 발생여부와 관계없이 실행됨
		 * 
		 * < 기본 문법 >
		 * try {
		 * 		// 예외 발생할 가능성이 있는 코드
	...
	public static void method() {
		 ...
		 * 
		 * 1. 예외가 발생하지 않을 경우
		 * 		1 -> 2 -> return문 (아직 실행X) -> 4(finally 블록 실행) -> return
		 * 
		 * 2. 예외가 발생했을 경우
		 * 		1 -> 예외 발생 -> 3(catch블록 실행) -> 4(finally 블록 실행) -> 5
		 * 
		 * 
		 * */
