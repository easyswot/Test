...
public class Ex1 {
	...
	public static void main(String[] args) {
		 ...
		 * 		 예외가 발생할 상황을 미리 탐지하며 예외가 발생했을 때
		...
		int num1 = 10, num2 = 0;
		// 자바에서는 연산 시 두번째 피연산자가 0일 경우 나눗셈 과정에서 예외 발생
//		System.out.println(num1 + " / " + num2 + " = " + (num1/num2));
		 ...
		 * at try_catch.Ex1.main(Ex1.java:32)
		 * 
		 ...
		 * 
		 * 3. at try_catch.Ex1.main(Ex1.java:32)
		 * 	  => 예외 발생 위치(Ex1.java 클래스의 32번 라인에서 예외 발생)
		 * 
		 * */
		
		// 만약, 예외가 발생하지 않도록 if문을 통해서 피연산자 값 검사하는 경우
		// 예외 처리가 아니다
		if(num2 != 0) {
			System.out.println(num1 + " / " + num2 + " = " + (num1/num2));
		}
		
		String str = null;	// 참조 면수에 저장된 주소값이 없음
		// null 값을 참조하는 객체에 접근하여 작업을 수행하려 할 경우
		// 접근이 불가능하므로 NullPinterException 예외가 발생하게 된다.
