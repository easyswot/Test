...
public class Ex3 {
	...
	public static void main(String[] args) {
		 ...
		 * - 따라서, 해당 문자열을 실제 연산을 위해 수치데이터 동의
		 * 	 기본데이터타입으로 변환하려면 Wrapper 클래스에서 제공하는 메서드를 통해
		 * 	 해당 테입으로 변환해야한다
		 * 
		...
		String strNum = "3.14";
		System.out.println(strNum + 10);	// 문자열 데이터이므로 결합연산으로 동작
		System.out.println("--------------------");
		double dNum = Double.parseDouble(strNum);
		System.out.println(dNum);
		System.out.println(dNum + 10);	// 실수형 데이터이므로 산술연산으로 동작(13.14)
