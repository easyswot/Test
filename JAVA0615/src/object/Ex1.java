...
public class Ex1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(p1);	// Person@6d06d69c (@뒤의 16진수 숫자응 다를 수 있음)
		
		Person p2 = new Person();
		System.out.println(p2);	// Person@7852e922 (@뒤의 16진수 숫자응 다를 수 있음)
		 ...
		 * - 해당 클래스의 클래스명을 얻으려면 getClass() 메서드 켤과에 다시 .getName() 붙임
		 * 
		 * */
