...
public class Ex3 {
	...
	public static void main(String[] args) {
		 ...
		 * 		  => 보조스트림을 사용하는 시트림 체이닝(Stream Chaning) 방식 문법 구성
		 * 		- read() 메서드를 호출하여 입력데이터를 char단위(2Byte)만큼 읽어와서 저장
		 * 		- 아무리 많은 데이터가 입력되어도 2Byte(char) 만큼만 다를 수 있기 때문데
		 * 		  더 많은 데이터나 더 큰 자위 처리가 불가능
...
//		InputStream is = System.in;
		...
		// 2. InputStreamReader 객체 생성 => 파라미터로 is 객체를 전달
