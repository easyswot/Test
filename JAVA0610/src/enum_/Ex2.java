...
public class Ex2 {
	...
	public static void main(String[] args) {
		 ...
		 * */
		Ex2 ex2 = new Ex2();
		ex2.compareEnum(Season.SPRING);
		

	}
	
	public void compareEnum(Season season) {	// enum 타입 (Season타입) 객체(season)를 전달 받음
...
//		System.out.println(season.compareTo(season.WINTER));
		...
		if(season == Season.SPRING) {
			...
			// season(FALL(2)) - Season.WINTER(3) = -1
			// season(WINTER(3)) - Season.WINTER(3) = 0
