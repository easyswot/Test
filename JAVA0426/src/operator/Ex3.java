...
public class Ex3 {
	...
	public static void main(String[] args) {
		 ...
		 * ex) int + double = (double)int + dobule = 결과가 double타입
		 * 
		 * 
		 * 
		 * */
...
//		long l2 = l + f;	//err long + float => float + float => float
		long l2 = (long)(l+f);
...
//		10/(double)3		int/3.0 => 10.0/3.0 => 3.3333
		
		byte b1 = 10, b2 = 20, b3;
		b3 = 10+20;		//상수(리터럴) 끼리의 연산은 형변환이 발생하지 않는다
//		b3 = 100+20;	//err 리터럴끼리의 연산이더라도 범위를 초과하면 오류 발생
